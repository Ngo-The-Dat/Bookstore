...
import { Book } from "@/types/product.types";
...
async function getBooks() {
  try {
    ...
    // Chuyển đổi toàn bộ mảng Book sang Product
    return books.map(mapBookToProduct);
  } catch (error) {
...
// --- SỬA Ở ĐÂY: Thêm từ khóa 'async' ---
export default async function Home() {
  const products = await getBooks();

  // Chia dữ liệu để hiển thị

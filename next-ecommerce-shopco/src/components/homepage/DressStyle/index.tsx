  ...
  return (
    <div className="px-4 xl:px-0">
      <section className="max-w-frame mx-auto bg-[#F0F0F0] px-6 pb-6 pt-10 md:p-[70px] rounded-[40px] text-center">
        ...
        >
          <DressStyleCard
            title="Fiction" // Tiểu thuyết
            url="/shop?category=fiction"
            // Thay đổi đường dẫn ảnh ở đây
            className="md:max-w-[260px] lg:max-w-[360px] xl:max-w-[407px] h-[190px] bg-[url('/images/cat-fiction.png')]"
          />
          <DressStyleCard
            title="Business" // Kinh tế
            url="/shop?category=business"
            className="md:max-w-[684px] h-[190px] bg-[url('/images/cat-business.png')]"
          />
        </motion.div>
        ...
        >
          <DressStyleCard
            title="Children" // Thiếu nhi
            url="/shop?category=children"
            className="md:max-w-[684px] h-[190px] bg-[url('/images/cat-children.png')]"
          />
          <DressStyleCard
            title="Science" // Khoa học
            url="/shop?category=science"
            className="md:max-w-[260px] lg:max-w-[360px] xl:max-w-[407px] h-[190px] bg-[url('/images/cat-science.png')]"
          />
        </motion.div>
      </section>
    </div>

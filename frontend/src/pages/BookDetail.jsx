                    ...
                    <div key={review._id} className="border-b pb-4 last:border-b-0">
                      {isEditing ? (
                        ...
                        <div className="bg-gray-50 p-4 rounded-lg">
                          <h4 className="font-semibold mb-3">Chỉnh sửa đánh giá</h4>
                            ...
                            <div className="flex">
                              {[1, 2, 3, 4, 5].map((star) => (
                                <button
                                  ...
                                  className={`text-xl focus:outline-none ${star <= editRating ? 'text-yellow-400' : 'text-gray-300'}`}
                                >
                                  ★
                                </button>
                              ))}
                          ...
                          <div className="flex justify-end gap-2">
                            ...
                            <Button size="sm" onClick={handleUpdateReview}>Lưu thay đổi</Button>
                          </div>
                        </div>
                      ) : (
                        /* View Mode */
